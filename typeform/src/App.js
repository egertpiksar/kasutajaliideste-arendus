          ...
          <div className="footer-container">
            <div className="col column1">
                <ul>
                  <li>
                    {/* copied */}
                      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="img-svg replaced-svg" style={{width: "30px", height: "30px"}} aria-hidden="true" focusable="false">
